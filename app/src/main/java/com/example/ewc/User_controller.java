...
public class User_controller extends AppCompatActivity implements SensorEventListener{
    ...
    private Integer[] imgView_id= {R.id.view, R.id.view1, R.id.view3, R.id.view4, R.id.view5, R.id.view6};
    ...
    private ValueAnimator[] vaAni = new ValueAnimator[6];
...
//    private ValueAnimator colorAnimationOuter6;
    ...
    final int go = 42; // 12 한번 바뀌는데 걸리는 시간 즉 흰색에서 파란색으로 될 때까지의 시간이 42ms -> 12HZ
    final int back = 50; // 10
    final int left = 58; // 8.5
    final int right = 67; // 7.56
    final int turn_right = 36; // 14
    final int turn_left = 31; // 16
//    final int turn_right = 25; // 20


    Integer ord[] = {turn_left,go, turn_right,back,right,left};
