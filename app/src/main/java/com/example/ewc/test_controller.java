...
public class test_controller extends AppCompatActivity implements SensorEventListener {
...
//                    User_controller.Task1 crash = new User_controller.Task1();
//                    crash.start();
                ...
                if(conn != null){
                    ...
                    if(resCode == HttpURLConnection.HTTP_OK){
                        ...
                        if (responseData.equals("success")) {
                            ...
                            // 다른 응답을 반환한 경우
                            // 로그인 실패
                            Toast.makeText(test_controller.this, "위치 전송 실패", Toast.LENGTH_SHORT).show();
                        }
                    }
                    conn.disconnect();
                }
                ...
                if(conn != null){
                    ...
                    if(resCode == HttpURLConnection.HTTP_OK){
                        ...
                        if (responseData.equals("success")) {
                            ...
                            Toast.makeText(test_controller.this, "보호자에게 알림을 전송했습니다.", Toast.LENGTH_LONG).show();
